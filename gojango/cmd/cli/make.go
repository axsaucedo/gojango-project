...
func doMake(arg2, arg3 string) error {
	...
	case "handler":
		...
		fileName := gg.RootPath + "/handlers/" + strings.ToLower(arg3) + ".go"
	...
	case "mail":
		...
		htmlMail := gg.RootPath + "/mail/" + strings.ToLower(arg3) + ".html.tmlp"
		plainMail := gg.RootPath + "/mail/" + strings.ToLower(arg3) + ".plain.tmlp"
